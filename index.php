...
<head>
  ...
  <meta name="keywords" content="bus, school bus, gps, bus tracker, gps tracker, mobile tracker, delivery, india, digital india, track package">
	...
	<title> Trakkerz - GPS Tracker Track School Bus, Track Salesman, Track Package </title>
		...
		<div class="container">
			...
			<div class="mbr-table">
				<div class="mbr-table-cell">
						...
						<a class="navbar-brand" href=""><span><img id="idLogo" style="width: 20px;height: 27px; margin-left: 3px; margin-bottom: 6px; " src="assets/images/trakkerzwhite.png" alt="Logo"><a class="navbar-caption" href="index.php" style="color:#4d79bf;">Trakkerz</a>
				...
				<div class="mbr-table-cell">
					...
					<li class="nav-item" style="color: #5994ff"><a class="nav-link link mbr-editable-menu-item" href="careers.php" style="color: #4d79bf">CAREERS</a></li>
					<li class="nav-item" style="color: #5994ff"><a class="nav-link link mbr-editable-menu-item" href="./trakkerz/newLeadReport.html" style="color: #4d79bf">REPORT</a></li>
				  ...
				  <li class="nav-item nav-btn"><a class="nav-link btn btn-white btn-white-outline mbr-editable-menu-item" target="_blank" href="https://www.facebook.com/trakkerz/" style="color: #4d79bf"><span class="mbri-like mbr-iconfont mbr-iconfont-btn"></span>LIKE US ON FACEBOOK!</a></li><li class="nav-item nav-btn"><a class="nav-link btn btn-white btn-white-outline mbr-editable-menu-item" href="http://bit.ly/2xyfvoN" target="_blank" style="color: #4d79bf"><span class="mbri-android mbr-iconfont mbr-iconfont-btn"></span>GET IT ON PLAYSTORE!</a></li>
				...
				<div class="mbr-section row">
					<div class="mbr-table-md-up">
						...
						<div class="mbr-table-cell mbr-valign-top mbr-left-padding-md-up col-md-7 image-size" style="width: 50%;"><center>
							<div class="mbr-figure col-sm-12" style="width:90%"><img alt="this image contains trakkerz app screens containing create group and live tracking on map map" src="assets/images/app-showcase.png"></div></center>
						</div>
...
<section class="mbr-cards mbr-section mbr-section-nopadding" id="features1-e" style="background-color: rgb(244, 244, 244);">
	...
	<div class="mbr-cards-row row striped">
		...
		<div class="mbr-cards-col col-xs-12 col-lg-3" style="padding-top: 80px; padding-bottom: 80px;">
			<div class="container">
				<div class="card cart-block">
					<div class="card-img"><img alt="Trakkerz app screen showing how to create a group" src="assets/images/screenshots/011.png" class="card-img-top"></div>
		...
		<div class="mbr-cards-col col-xs-12 col-lg-3" style="padding-top: 80px; padding-bottom: 80px;">
			<div class="container">
				<div class="card cart-block">
					<div class="card-img"><img alt="Trakkerz app screen showing add members to a group on Trakkerz" src="assets/images/screenshots/022.png" class="card-img-top"></div>
					<div class="card-block">
						<h4 class="card-title">Add members</h4><!-- Amit G 06 Nov, 2017 -->
						<h5 class="card-subtitle">Whom you want to Track</h5><!-- Amit G 06 Nov, 2017 -->
						<p class="card-text">New members will get an invite sms after they are added to the Group.</p><!-- Amit G 06 Nov, 2017 -->
		...
		<div class="mbr-cards-col col-xs-12 col-lg-3" style="padding-top: 80px; padding-bottom: 80px;">
			<div class="container">
				<div class="card cart-block">
					<div class="card-img"><img alt="Trakkerz app screen showing Live Location Tracking on Map" src="assets/images/screenshots/033.png" class="card-img-top"></div>
					<div class="card-block">
		...
		<div class="mbr-cards-col col-xs-12 col-lg-3" style="padding-top: 80px; padding-bottom: 80px;">
			<div class="container">
				<div class="card cart-block">
					<div class="card-img"><img alt="Trakkerz app screen showing how to set proximity locations on app." src="assets/images/screenshots/044.png" class="card-img-top"></div>
					<div class="card-block">
...
<div id="fh5co-features" data-section="contact">
		<div class="container">
			<div class="row">
				...
				<center>
					<h3 class="animate-box mbr-section-title display-2" data-animate-effect="fadeIn">Contact us for a demo</h3>
			...
			<div class="row row-bottom-padded-sm">
				<div class="col-md-6 col-sm-12 col-xs-12 col-xxs-12 fh5co-service animate-box" data-animate-effect="fadeIn">
					<div class="fh5co-desc">
						<p>
						<b>Head Office :</b><br> 24, Hemanta Basu Sarani, Suite 309, Mangalam Apt., Block-A, Kolkata 700001<br><br>
						<b>Regional Office :</b><br> B-66, Kasturba Nagar 1st Floor, Facing Chetak Bridge, Bhopal - 462023<br><br>
						<b>Email :</b><br> contact@trakkerz.com<br><br>
						<b>Phone :</b><br> +91-33-4601-4867,<br>
						 +91-8820088000
						</p>
					</div>
					<div id="map"></div><br />
...
<section class="mbr-section article" id="msg-box22-g" style="padding-top: 40px; padding-bottom: 20px;">
	...
	<div class="container">
		<div class="row">
			<div class="col-md-8 col-md-offset-2 text-xs-center">
				<p>(c) 2018 All Rights Reserved <a  href="http://trakkerz.com" style="color:#333;text-decoration:underline;"> Trakkerz</a></p>
			</div>
		</div>
	</div>
